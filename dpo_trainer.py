...
class DPOTrainer(Trainer):
    ...
    def dpo_loss(
        ...
        b=self.c1/(self.c2-ref_logratios)
        ...
        if self.loss_type == "sigmoid":
            ...
            losses=-F.logsigmoid(self.c1* logits/(self.c2-ref_logratios))
            ...
            raise ValueError(
                f"Unknown loss type: {self.loss_type}. Should be one of ['sigmoid', 'hinge', 'ipo', 'exo_pair','tpo', "
