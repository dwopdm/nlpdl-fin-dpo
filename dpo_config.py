...
class DPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        c1 (`float`, *optional*, defaults to `1.0`):
            Parameter controlling the trade-off between the IPO loss and the KL divergence. For the IPO loss
            (`loss_type="ipo"`), c1 is the coefficient denoted by γ in the [paper](https://huggingface.co/papers/2310.12036).
        c2 (`float`, *optional*, defaults to `1.0`):        
            Parameter controlling the trade-off between the IPO loss and the KL divergence. For the IPO loss
